...
export const useStore = create<LinkState>((set, get) => ({
  ...
  tags: [],
  socialLinks: [
    { id: 'instagram', name: 'Instagram', url: 'instagram.com/pla_korea', icon: 'Instagram' },
    { id: 'linkedin', name: 'LinkedIn', url: 'linkedin.com/company', icon: 'Linkedin' },
    { id: 'twitter', name: 'X', url: 'x.com/PLANHOM', icon: 'Twitter' },
    { id: 'youtube', name: 'Youtube', url: 'youtube.com/@planhom', icon: 'Youtube' },
  ],
  searchTerm: '',
  selectedTagId: null,
  isDarkMode: false,
